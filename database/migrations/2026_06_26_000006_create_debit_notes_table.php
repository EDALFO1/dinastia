...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('debit_notes', function (Blueprint $table) {
            ...
            $table->string('razon_ajuste'); // Válida según DIAN (ej: "Por intereses")
            $table->text('descripcion_ajuste')->nullable();
            $table->date('fecha_emision');
            $table->decimal('porcentaje_adicion', 5, 2)->default(0);
            $table->decimal('valor_adicion', 12, 2)->default(0);
            $table->decimal('valor_impuesto_adicion', 12, 2)->default(0);
